...
This is an example of incorrect rendering of a document number if you start typing it from left to right: "123‎الف‎456" you will get "الف123456" in the input (depending on your browser or Operating System it may vary).
